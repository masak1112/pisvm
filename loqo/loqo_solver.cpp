					   ...
					   int npcols, int nb_distr) : Solver_LOQO(n,q,m)
{
  ...
  ierr = PLA_Comm_1D_to_2D(comm, nprows, npcols, &comm); CheckError(ierr);
  // Initialize PLAPACK
  ierr = PLA_Init(comm); CheckError(ierr);
  ierr = PLA_Temp_create(nb_distr, 0, &templ); CheckError(ierr);
  // Initialize PLAPACK objs
  Q_bb_global = NULL; c_global = NULL; up_global = NULL; 
  low_global = NULL; a_global = NULL; d_global = NULL;
  x = NULL; dist = NULL; g = NULL; t = NULL; yy = NULL; z = NULL;
  s = NULL; plus_one = NULL; Q_bb_global_view = NULL;
  c_global_view = NULL; up_global_view = NULL;
  low_global_view = NULL; a_global_view = NULL;
  x_view = NULL; dist_view = NULL; g_view = NULL; t_view = NULL;
  z_view = NULL; s_view = NULL; x_loc_view = NULL;
  x_loc = NULL; yy_loc = NULL; dist_loc = NULL;
  dist_loc_view = NULL;
}
...
{
  // Finalize PLAPACK
  ierr = PLA_Finalize(); CheckError(ierr);
}
