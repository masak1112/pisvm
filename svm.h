...
/*   }; */
  ...
  void svm_predict_values(const struct svm_model *model, const Xfloat *x, 
			  const int *nz_x, const int lx, double* dec_values);
  double svm_predict(const struct svm_model *model, const Xfloat *x, 
		     const int *nz_x, const int lx);
  double svm_predict_probability(const struct svm_model *model, 
				 const Xfloat *x, const int *nz_x, 
				 const int lx, double* prob_estimates);
